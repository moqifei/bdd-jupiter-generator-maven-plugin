...
public class SpringCodeFactory extends AbstractTestCodeFactory {
	public SpringCodeFactory(JavaSourceCodeParser JavaSourceCodeParser, JavaTestCodeParser javaTestCodeParser,
	...
	protected String initInstance() {
		...
		importSet.add(impo + " org.springframework.test.context.ContextConfiguration;");
		...
		annotationsSet.add("@ContextConfiguration(\"classpath:spring/spring-config-test.xml\")");
